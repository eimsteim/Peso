	...
	function(a, b) {
		function c(b, c) {
			...
			this.toggleMenu = function(c, d) {
				...
				var d = !(c === !1 || d === !1);
				//zhangchi: enable or disable tooltip
				if(this.minimized){
					this.$sidebar.addClass("menu-min");
					this.$sidebar.find('a[data-rel=tooltip]').tooltip({container:'body'});
				}else {
					this.$sidebar.removeClass("menu-min");
					this.$sidebar.find('a[data-rel=tooltip]').tooltip('destroy');
				}
			...
			o.call(f), a(window).on("resize.sidebar.vars", function() {
				...
				if(d && 0 != d.length) {
					...
					if(d.hasClass("dropdown-toggle")) {
						...
						//zhangchi: toggle left icon
						$(this).children(".open").find('i.fa-caret-down').removeClass('fa-caret-down').addClass('fa-caret-right');
